...
system(f"python llmbo.py --history 0 --refined 0 --model GPT-4o  --related_ckts \"Two_Stage_Differential_Amplifier\"")
for model in models:
    system(f"python llmbo.py --history 1 --refined 0 --model {model}  --related_ckts \"Two_Stage_Differential_Amplifier\"")
for model in models:
    system(f"python llmbo.py --history 1 --refined 1 --model {model}  --related_ckts \"Two_Stage_Differential_Amplifier\"")
