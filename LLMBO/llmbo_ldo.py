...
class LLMBO(object):
    ...
    def optimize(self, args):
        ...
        # with open(f"results/{args.history}_{args.refined}_ldo_{args.model}.txt" , 'w') as f:
        ...
        np.savetxt(f"results/foms_{args.history}_{args.refined}_ldo_{args.model}.txt", np.array(fom_array), fmt="%.4f")
